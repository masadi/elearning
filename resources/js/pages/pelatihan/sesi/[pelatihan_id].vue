...
const isAddNewData = () => {
  router.push({ name: 'pelatihan-sesi-tambah-pelatihan_id', params: {pelatihan_id: route.params.pelatihan_id} })
}
...
const ujianSesi = async(val) => {
  ...
  //router.push({ name: 'pelatihan-sesi-id', params: {id: val.sesi_latihan_id} })
}
...
const editData = async(val) => {
  ...
  router.push({ name: 'pelatihan-sesi-id', params: {id: val} })
