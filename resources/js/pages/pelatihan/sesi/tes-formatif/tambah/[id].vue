...
const inputData = ref({
  ...
  deskripsi: null,
  jawaban: [
    {opsi: 'A', deskripsi: null, benar: 0},
    {opsi: 'B', deskripsi: null, benar: 0},
    {opsi: 'C', deskripsi: null, benar: 0},
    {opsi: 'D', deskripsi: null, benar: 0},
...
watch(isSnackbarClicked, () => {
  if(isSnackbarClicked.value){
    router.push({ name: 'pelatihan-sesi-tes-formatif-id', params: {id: sesi_latihan.value.sesi_latihan_id} })
  }
})
const kunci = [
  {
...
<template>
  <VCard :title="`Tambah Tes Formatif Sesi ${sesi_latihan.judul}`">
